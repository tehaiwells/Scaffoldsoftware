...
export class Simulation {
  ...
  execute(action,input,key){
    ...
    else if(['opening','purchase','removeStock','approveCount'].includes(action))this.auth.require(this.user,'stock.adjust');
